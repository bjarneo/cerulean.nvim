...
-- For more advanced configuration, use: require('cerulean').setup()

-- Check if the user wants to use the modular system
local ok, cerulean_colorscheme = pcall(require, "cerulean")
if ok then
	-- Use the modular system with default configuration
	cerulean_colorscheme.setup()
	cerulean_colorscheme.load()
	return
end
...
local palette = {
	...
	bright_red = "#33A1E0",
	bright_green = "#33A1E0",
	bright_yellow = "#FFF9AF",
	bright_blue = "#33A1E0",
	bright_magenta = "#33A1E0",
	bright_cyan = "#33A1E0",
	bright_white = "#FFF9AF",
}
